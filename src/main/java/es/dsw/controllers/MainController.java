...
/* [6] CREACIÓN DE LAS CONTROLADORAS
 * 
 * La Java Annotation @Controller le indicará al servlet de Spring configurado en sessionContext.xml que se trata de una controladora
 * que mapea una serie de rutas lógicas de cliente. Recuerda que para que mapeé esta clase debe estar especificado el paquete bajo el cual
 * cuelga la controladora en el fichero en el .xml de la definición del contenedor del servlet (sessionContext.xml).
 */
@Controller
